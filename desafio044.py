...
if fp == '1':
    ...
    vd = vp - (vp/100*10)
    print(f'\033[7;40m Valor a ser pago com desconto de 10% por ser pagamento em cheque. \n Valor final: R${vd:.2f}')
elif fp == '3':
    vd = vp - ((vp*10)/100)
    print(f'Valor a ser pago com desconto de 10% por ser pagamento em dinheiro. \n Valor final: R${vd:.2f}')
else:
